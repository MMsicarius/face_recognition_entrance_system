...
class SimpleFacerec:
    ...
    def search_credentials(self, name):
        answer = self.credentials.loc[self.credentials["Name"] == name, ["Access Level"]].values[0]
        return answer
    ...
    def detect_known_faces(self, frame):
        ...
        for face_encoding in face_encodings:
            ...
            if matches[face_best_matching] and \
                    SimpleFacerec.search_credentials(self, str(self.names[face_best_matching])) >= self.access_level:
            ...
            #print(SimpleFacerec.search_credentials(self, iterate_counter), self.access_level, access_state)
            iterate_counter += 1
